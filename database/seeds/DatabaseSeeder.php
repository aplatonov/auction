...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('block_reasons')->insert([
            ['block_descr' => 'Заблокирован администратором'],
            ...
            ['block_descr' => 'Заблокирован пользователем'],
        ]);
        ...
        DB::table('articles')->insert([
            ['descr' => 'Незарегистрированные пользователи могут только просматривать лоты. Для того, чтобы размещать лоты и делать ставки необходимо зарегистрироваться', 'short_descr' => 'правила участия в аукционе'],
            ['descr' => 'Администратор имеет право заблокировать любого пользователя и лот, если он нарушает правила аукциона', 'short_descr' => 'правила участия в аукционе'],
            ['descr' => 'Аукцион продолжается до истечения отведенного на него времени. Победителем объявляется пользователь, сделавший наибольшую ставку. При одинаковых ставках выигрывает та, что была сделана раньше', 'short_descr' => 'правила участия в аукционе']
        ]); 
    }
}
